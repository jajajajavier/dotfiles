...
keys = [
    ...
    # cambia distribucion de ventanas. Para agregar o quitar distribuciones editar: ~/.config/qtile/conf/layout.py
    ...
    # Apagar Qtile
    Key([mod, "control"], "Pause", lazy.shutdown(),             desc="Win + Control izq. + Pause"),
   ...
   # >>>>>>>>>>>>>>>|Otros|<<<<<<<<<<<<<<<
    ...
    # screenshoot
    Key([mod, "shift"], "s", lazy.spawn("xfce4-screenshooter -r"),          desc="Win + Shift + s"), 
]
