...
# de Antonio Sarosi, tambien con un canal en youtube, mas que nada para tomar su archivo themes.py
# porque estaba haciendo algo para cambiar temas de colores pero se estaba llenando de codigo basura
# y errores, y con el suyo andaba de pana
#
#
# CREDITS=
#
