...
keys = [
    ...
    # Mute audio
    Key([], "XF86AudioMute", lazy.spawn("pamixer --toggle-mute"),           desc="Fn + mute"),
    ...
    Key([], "XF86MonBrightnessDown", lazy.spawn("xbacklight +5%"),   desc="Fn + Flecha izquierda"),

    # Decrease Brightness  5%
    Key([], "XF86MonBrightnessUp", lazy.spwan("xbacklight -5%"),     desc="Fn + Flecha derecha"),
